...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Nameserver.description'
        db.alter_column('nameserver', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=1000))

    def backwards(self, orm):

        # Changing field 'Nameserver.description'
        db.alter_column('nameserver', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1377720456'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
