...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SSHFP.description'
        db.alter_column('sshfp', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=1000))

        # Changing field 'SSHFP.fqdn'
        db.alter_column('sshfp', 'fqdn', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'SSHFP.label'
        db.alter_column('sshfp', 'label', self.gf('django.db.models.fields.CharField')(default='', max_length=63))

    def backwards(self, orm):

        # Changing field 'SSHFP.description'
        db.alter_column('sshfp', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'SSHFP.fqdn'
        db.alter_column('sshfp', 'fqdn', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SSHFP.label'
        db.alter_column('sshfp', 'label', self.gf('django.db.models.fields.CharField')(max_length=63, null=True))
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1377720467'}),
