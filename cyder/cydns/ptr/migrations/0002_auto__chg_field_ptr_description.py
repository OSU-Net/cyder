...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PTR.description'
        db.alter_column('ptr', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=1000))

    def backwards(self, orm):

        # Changing field 'PTR.description'
        db.alter_column('ptr', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1370905947'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'view.view': {
