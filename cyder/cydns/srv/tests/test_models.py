...
class SRVTests(TestCase):
    ...
    def do_generic_add(self, data):
        ...
        self.assertTrue(srv.get_detail_url())
    ...
    def test_add_remove_srv(self):
        ...
        self.do_remove(data)
        data = {'label': '_', 'domain': self.o, 'target':
    ...
    def test_invalid_add_update(self):
        ...
        data = {'label': '_df', 'domain': self.o_e, 'target':
                'foo.oregonstate.edu', 'priority': 2, 'weight': 2222, 'port': 222}
