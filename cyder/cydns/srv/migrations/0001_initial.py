...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('srv', (
            ...
            ('target', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1368821007'}),
