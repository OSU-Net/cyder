...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SOA.created'
        db.add_column('soa', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SOA.modified'
        db.add_column('soa', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SOA.created'
        db.delete_column('soa', 'created')

        # Deleting field 'SOA.modified'
        db.delete_column('soa', 'modified')
    ...
    models = {
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1381524620'}),
