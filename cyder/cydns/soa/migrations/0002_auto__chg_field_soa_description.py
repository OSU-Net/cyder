...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SOA.description'
        db.alter_column('soa', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

    def backwards(self, orm):

        # Changing field 'SOA.description'
        db.alter_column('soa', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    models = {
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1370905954'}),
