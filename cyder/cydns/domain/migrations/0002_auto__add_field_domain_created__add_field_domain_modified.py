...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('domain', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Domain.modified'
        db.add_column('domain', 'modified',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('domain', 'created')

        # Deleting field 'Domain.modified'
        db.delete_column('domain', 'modified')
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1381524390'}),
