...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('ctnr', ['Ctnr'])

        # Adding M2M table for field domains on 'Ctnr'
        db.create_table('ctnr_domains', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ctnr', models.ForeignKey(orm['ctnr.ctnr'], null=False)),
            ('domain', models.ForeignKey(orm['domain.domain'], null=False))
        ))
        db.create_unique('ctnr_domains', ['ctnr_id', 'domain_id'])

        # Adding M2M table for field ranges on 'Ctnr'
        db.create_table('ctnr_ranges', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ctnr', models.ForeignKey(orm['ctnr.ctnr'], null=False)),
            ('range', models.ForeignKey(orm['range.range'], null=False))
        ))
        db.create_unique('ctnr_ranges', ['ctnr_id', 'range_id'])

        # Adding M2M table for field workgroups on 'Ctnr'
        db.create_table('ctnr_workgroups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ctnr', models.ForeignKey(orm['ctnr.ctnr'], null=False)),
            ('workgroup', models.ForeignKey(orm['workgroup.workgroup'], null=False))
        ))
        db.create_unique('ctnr_workgroups', ['ctnr_id', 'workgroup_id'])
        ...
        db.send_create_signal('ctnr', ['CtnrUser'])
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1368820853'}),
