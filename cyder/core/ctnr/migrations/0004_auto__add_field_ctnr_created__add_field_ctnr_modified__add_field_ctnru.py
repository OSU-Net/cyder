...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ctnr.created'
        db.add_column('ctnr', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ctnr.modified'
        db.add_column('ctnr', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CtnrUser.created'
        db.add_column('ctnr_users', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CtnrUser.modified'
        db.add_column('ctnr_users', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ctnr.created'
        db.delete_column('ctnr', 'created')

        # Deleting field 'Ctnr.modified'
        db.delete_column('ctnr', 'modified')

        # Deleting field 'CtnrUser.created'
        db.delete_column('ctnr_users', 'created')

        # Deleting field 'CtnrUser.modified'
        db.delete_column('ctnr_users', 'modified')
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1381523973'}),
