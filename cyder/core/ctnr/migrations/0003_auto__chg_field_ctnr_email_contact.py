...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ctnr', 'email_contact', self.gf('django.db.models.fields.CharField')(max_length=75))

    def backwards(self, orm):

        # Changing field 'Ctnr.email_contact'
        db.alter_column('ctnr', 'email_contact', self.gf('django.db.models.fields.EmailField')(max_length=75))
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1373668717'}),
