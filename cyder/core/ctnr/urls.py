...
urlpatterns = patterns('cyder.core.ctnr.views',
    ...
    url(r'(?P<pk>[\w-]+)/update/$', CtnrUpdateView.as_view(), name='ctnr-update'),
    url(r'(?P<pk>[\w-]+)/delete/$', CtnrDeleteView.as_view(), name='ctnr-delete'),
    url(r'(?P<pk>[\w-]+)/add_user/$', CtnrUserCreateView.as_view(), name='ctnr-add-user'),
