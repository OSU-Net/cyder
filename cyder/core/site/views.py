...
from cyder.core.site.models import Site, SiteKeyValue
from cyder.core.site.forms import SiteForm
from cyder.core.site.utils import get_vlans
...
from cyder.core.views import CoreCreateView, CoreUpdateView
