...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('auth_user_profile', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.modified'
        db.add_column('auth_user_profile', 'modified',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('auth_user_profile', 'created')

        # Deleting field 'UserProfile.modified'
        db.delete_column('auth_user_profile', 'modified')
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1381523982'}),
