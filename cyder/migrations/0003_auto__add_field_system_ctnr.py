...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'System.ctnr'
        db.add_column('system', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cyder.Ctnr']),
                      keep_default=False)
        if not db.dry_run:
            for sys in orm.System.objects.all():
                interfaces = (list(sys.staticinterface_set.all()) +
                              list(sys.dynamicinterface_set.all()))
                if not interfaces:
                    sys.delete()
                else:
                    sys.ctnr = interfaces[0].ctnr
                sys.save()


    def backwards(self, orm):
        # Deleting field 'System.ctnr'
        db.delete_column('system', 'ctnr_id')
    ...
    models = {
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1425593340'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
