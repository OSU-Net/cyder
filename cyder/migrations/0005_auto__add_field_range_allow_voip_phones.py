...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Range.allow_voip_phones'
        db.add_column('range', 'allow_voip_phones',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Range.allow_voip_phones'
        db.delete_column('range', 'allow_voip_phones')
    ...
    models = {
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1384895607'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
