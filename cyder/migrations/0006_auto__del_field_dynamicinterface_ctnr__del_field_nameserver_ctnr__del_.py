...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DynamicInterface.ctnr'
        db.delete_column('dynamic_interface', 'ctnr_id')

        # Deleting field 'Nameserver.ctnr'
        db.delete_column('nameserver', 'ctnr_id')

        # Deleting field 'StaticInterface.ctnr'
        db.delete_column('static_interface', 'ctnr_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DynamicInterface.ctnr'
        raise RuntimeError("Cannot reverse this migration. 'DynamicInterface.ctnr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DynamicInterface.ctnr'
        db.add_column('dynamic_interface', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.Ctnr']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Nameserver.ctnr'
        raise RuntimeError("Cannot reverse this migration. 'Nameserver.ctnr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Nameserver.ctnr'
        db.add_column('nameserver', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.Ctnr']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'StaticInterface.ctnr'
        raise RuntimeError("Cannot reverse this migration. 'StaticInterface.ctnr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'StaticInterface.ctnr'
        db.add_column('static_interface', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.Ctnr']),
                      keep_default=False)
    ...
    models = {
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1431123194'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
