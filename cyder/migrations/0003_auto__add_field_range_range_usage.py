...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Range.range_usage'
        db.add_column('range', 'range_usage',
                      self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Range.range_usage'
        db.delete_column('range', 'range_usage')
    ...
    models = {
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1384299089'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
