...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        from cyder.models import Network
        for network in Network.objects.all():
            network.update_network()
            network.save()
        # Adding unique constraint on 'Network', fields ['start_upper', 'start_lower']
        db.create_unique('network', ['start_upper', 'start_lower'])


    def backwards(self, orm):
        # Removing unique constraint on 'Network', fields ['start_upper', 'start_lower']
        db.delete_unique('network', ['start_upper', 'start_lower'])
    ...
    models = {
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1435079130'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
