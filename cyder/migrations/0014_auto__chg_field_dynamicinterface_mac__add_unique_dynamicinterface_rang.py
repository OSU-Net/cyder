...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('dynamic_interface', 'mac', self.gf('cyder.core.fields.MacAddrField')(max_length=17, null=True, dhcp_enabled='dhcp_enabled'))
        ...
        db.alter_column('static_interface', 'mac', self.gf('cyder.core.fields.MacAddrField')(max_length=17, null=True, dhcp_enabled='dhcp_enabled'))
    ...
    models = {
        ...
        'cyder.dynamicinterface': {
            ...
            'mac': ('cyder.core.fields.MacAddrField', [], {'max_length': '17', 'null': 'True', 'dhcp_enabled': "'dhcp_enabled'"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1412626375'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
