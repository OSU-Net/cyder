...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Domain.soa'
        db.alter_column('domain', 'soa_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.SOA'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Domain.soa'
        db.alter_column('domain', 'soa_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.SOA'], null=True))
    ...
    models = {
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1413930525'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
