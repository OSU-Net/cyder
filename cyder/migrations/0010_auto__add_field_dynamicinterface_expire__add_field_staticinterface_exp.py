...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DynamicInterface.expire'
        db.add_column('dynamic_interface', 'expire',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticInterface.expire'
        db.add_column('static_interface', 'expire',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DynamicInterface.expire'
        db.delete_column('dynamic_interface', 'expire')

        # Deleting field 'StaticInterface.expire'
        db.delete_column('static_interface', 'expire')
    ...
    models = {
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1392068063'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
