...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MX.ctnr'
        db.add_column('mx', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cyder.Ctnr']),
                      keep_default=False)
        ...
        # Adding field 'PTR.ctnr'
        db.add_column('ptr', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cyder.Ctnr']),
                      keep_default=False)

        # Adding field 'TXT.ctnr'
        db.add_column('txt', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cyder.Ctnr']),
                      keep_default=False)

        # Adding field 'SRV.ctnr'
        db.add_column('srv', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cyder.Ctnr']),
                      keep_default=False)

        # Adding field 'AddressRecord.ctnr'
        db.add_column('address_record', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cyder.Ctnr']),
                      keep_default=False)

        # Adding field 'Nameserver.ctnr'
        db.add_column('nameserver', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cyder.Ctnr']),
                      keep_default=False)

        # Adding field 'SSHFP.ctnr'
        db.add_column('sshfp', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cyder.Ctnr']),
                      keep_default=False)
        ...
        # Adding field 'CNAME.ctnr'
        db.add_column('cname', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cyder.Ctnr']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MX.ctnr'
        db.delete_column('mx', 'ctnr_id')


        # User chose to not deal with backwards NULL issues for 'PTR.domain'
        raise RuntimeError("Cannot reverse this migration. 'PTR.domain' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PTR.domain'
        db.add_column('ptr', 'domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.Domain']),
                      keep_default=False)
        ...
        # Deleting field 'PTR.ctnr'
        db.delete_column('ptr', 'ctnr_id')

        # Deleting field 'TXT.ctnr'
        db.delete_column('txt', 'ctnr_id')

        # Deleting field 'SRV.ctnr'
        db.delete_column('srv', 'ctnr_id')

        # Deleting field 'AddressRecord.ctnr'
        db.delete_column('address_record', 'ctnr_id')

        # Deleting field 'Nameserver.ctnr'
        db.delete_column('nameserver', 'ctnr_id')

        # Deleting field 'SSHFP.ctnr'
        db.delete_column('sshfp', 'ctnr_id')
        ...
        # Deleting field 'CNAME.ctnr'
        db.delete_column('cname', 'ctnr_id')
    ...
    models = {
        ...
        'cyder.cname': {
            'Meta': {'object_name': 'CNAME', 'db_table': "'cname'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'ctnr': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cyder.Ctnr']"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'}),
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cyder.Domain']"}),
        ...
        'cyder.dynamicinterface': {
            ...
            'mac': ('cyder.core.fields.MacAddrField', [], {'max_length': '17', 'dhcp_enabled': "'dhcp_enabled'"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1408049250'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
