...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DynamicInterfaceAV.created'
        db.add_column('dynamic_interface_av', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DynamicInterfaceAV.modified'
        db.add_column('dynamic_interface_av', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticInterfaceAV.created'
        db.add_column('static_interface_av', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticInterfaceAV.modified'
        db.add_column('static_interface_av', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VlanAV.created'
        db.add_column('vlan_av', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VlanAV.modified'
        db.add_column('vlan_av', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SiteAV.created'
        db.add_column('site_av', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SiteAV.modified'
        db.add_column('site_av', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkgroupAV.created'
        db.add_column('workgroup_av', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkgroupAV.modified'
        db.add_column('workgroup_av', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VrfAV.created'
        db.add_column('vrf_av', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VrfAV.modified'
        db.add_column('vrf_av', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NetworkAV.created'
        db.add_column('network_av', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NetworkAV.modified'
        db.add_column('network_av', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SOAAV.created'
        db.add_column('soa_av', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SOAAV.modified'
        db.add_column('soa_av', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RangeAV.created'
        db.add_column('range_av', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RangeAV.modified'
        db.add_column('range_av', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SystemAV.created'
        db.add_column('system_av', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SystemAV.modified'
        db.add_column('system_av', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DynamicInterfaceAV.created'
        db.delete_column('dynamic_interface_av', 'created')

        # Deleting field 'DynamicInterfaceAV.modified'
        db.delete_column('dynamic_interface_av', 'modified')

        # Deleting field 'StaticInterfaceAV.created'
        db.delete_column('static_interface_av', 'created')

        # Deleting field 'StaticInterfaceAV.modified'
        db.delete_column('static_interface_av', 'modified')

        # Deleting field 'VlanAV.created'
        db.delete_column('vlan_av', 'created')

        # Deleting field 'VlanAV.modified'
        db.delete_column('vlan_av', 'modified')

        # Deleting field 'SiteAV.created'
        db.delete_column('site_av', 'created')

        # Deleting field 'SiteAV.modified'
        db.delete_column('site_av', 'modified')

        # Deleting field 'WorkgroupAV.created'
        db.delete_column('workgroup_av', 'created')

        # Deleting field 'WorkgroupAV.modified'
        db.delete_column('workgroup_av', 'modified')

        # Deleting field 'VrfAV.created'
        db.delete_column('vrf_av', 'created')

        # Deleting field 'VrfAV.modified'
        db.delete_column('vrf_av', 'modified')

        # Deleting field 'NetworkAV.created'
        db.delete_column('network_av', 'created')

        # Deleting field 'NetworkAV.modified'
        db.delete_column('network_av', 'modified')

        # Deleting field 'SOAAV.created'
        db.delete_column('soa_av', 'created')

        # Deleting field 'SOAAV.modified'
        db.delete_column('soa_av', 'modified')

        # Deleting field 'RangeAV.created'
        db.delete_column('range_av', 'created')

        # Deleting field 'RangeAV.modified'
        db.delete_column('range_av', 'modified')

        # Deleting field 'SystemAV.created'
        db.delete_column('system_av', 'created')

        # Deleting field 'SystemAV.modified'
        db.delete_column('system_av', 'modified')
    ...
    models = {
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1392090286'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
