...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Network.vrf'
        db.alter_column('network', 'vrf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.Vrf']))

    def backwards(self, orm):

        # Changing field 'Network.vrf'
        db.alter_column('network', 'vrf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.Vrf'], null=True))
    ...
    models = {
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1384300019'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
