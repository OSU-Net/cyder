...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Token.can_write'
        db.add_column('cyder_token', 'can_write',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Token.can_write'
        db.delete_column('cyder_token', 'can_write')
    ...
    models = {
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1393709494'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
