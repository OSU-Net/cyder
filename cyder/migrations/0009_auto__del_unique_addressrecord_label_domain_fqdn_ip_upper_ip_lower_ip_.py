...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'AddressRecord', fields ['fqdn', 'ip_str']
        db.create_unique('address_record', ['fqdn', 'ip_str'])

        # Adding unique constraint on 'StaticInterface', fields ['fqdn']
        db.create_unique('static_interface', ['fqdn'])

        # Adding unique constraint on 'StaticInterface', fields ['ip_str']
        db.create_unique('static_interface', ['ip_str'])


    def backwards(self, orm):
        # Removing unique constraint on 'StaticInterface', fields ['ip_str']
        db.delete_unique('static_interface', ['ip_str'])

        # Removing unique constraint on 'StaticInterface', fields ['fqdn']
        db.delete_unique('static_interface', ['fqdn'])

        # Removing unique constraint on 'AddressRecord', fields ['fqdn', 'ip_str']
        db.delete_unique('address_record', ['fqdn', 'ip_str'])
    ...
    models = {
        ...
        'cyder.addressrecord': {
            'Meta': {'unique_together': "(('fqdn', 'ip_str'),)", 'object_name': 'AddressRecord', 'db_table': "'address_record'"},
        ...
        'cyder.network': {
            'Meta': {'unique_together': "(('start_upper', 'start_lower'),)", 'object_name': 'Network', 'db_table': "'network'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1437596484'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
        ...
        'cyder.staticinterface': {
            'Meta': {'unique_together': "(('fqdn',), ('ip_str',))", 'object_name': 'StaticInterface', 'db_table': "'static_interface'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'}),
            'dhcp_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'dns_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
