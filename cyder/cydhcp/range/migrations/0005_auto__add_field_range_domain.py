...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('range', 'domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['domain.Domain'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1379549494'}),
