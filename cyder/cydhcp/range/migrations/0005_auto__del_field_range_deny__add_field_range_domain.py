...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Range.deny'
        db.delete_column('range', 'deny')
    ...
    def backwards(self, orm):
        # Adding field 'Range.deny'
        db.add_column('range', 'deny',
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1380069918'}),
