...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('range', (
            ...
            ('allow', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('deny', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ...
        db.execute_many(open("cyder/cydhcp/range/sql/range.sql").read())
