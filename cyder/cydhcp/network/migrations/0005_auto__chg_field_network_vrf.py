...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('network', 'vrf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vrf.Vrf']))

    def backwards(self, orm):

        # Changing field 'Network.vrf'
        db.alter_column('network', 'vrf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vrf.Vrf'], null=True))
