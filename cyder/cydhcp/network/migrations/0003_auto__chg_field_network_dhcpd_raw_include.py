...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Network.dhcpd_raw_include'
        db.alter_column('network', 'dhcpd_raw_include', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'Network.dhcpd_raw_include'
        db.alter_column('network', 'dhcpd_raw_include', self.gf('django.db.models.fields.TextField')(null=True))
