...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaticInterface.ctnr'
        db.add_column('static_interface', 'ctnr',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['ctnr.Ctnr']),
                      keep_default=False)
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1374890339'}),
