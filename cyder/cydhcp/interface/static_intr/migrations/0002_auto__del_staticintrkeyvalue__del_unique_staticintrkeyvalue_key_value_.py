...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('static_interface_av', (
            ...
            ('staticinterface', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['static_intr.StaticInterface'])),
        ...
        # Adding unique constraint on 'StaticInterfaceAV', fields ['staticinterface', 'attribute']
        db.create_unique('static_interface_av', ['staticinterface_id', 'attribute_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StaticInterfaceAV', fields ['staticinterface', 'attribute']
        db.delete_unique('static_interface_av', ['staticinterface_id', 'attribute_id'])
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1381194827'}),
        ...
        'static_intr.staticinterfaceav': {
            'Meta': {'unique_together': "(('staticinterface', 'attribute'),)", 'object_name': 'StaticInterfaceAV', 'db_table': "'static_interface_av'"},
            'attribute': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eav.Attribute']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'staticinterface': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['static_intr.StaticInterface']"}),
