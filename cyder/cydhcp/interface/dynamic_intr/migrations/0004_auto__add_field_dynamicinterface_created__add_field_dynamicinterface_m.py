...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DynamicInterface.created'
        db.add_column('dynamic_interface', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DynamicInterface.modified'
        db.add_column('dynamic_interface', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DynamicInterface.created'
        db.delete_column('dynamic_interface', 'created')

        # Deleting field 'DynamicInterface.modified'
        db.delete_column('dynamic_interface', 'modified')
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1381525062'}),
