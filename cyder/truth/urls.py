...
urlpatterns = patterns('cyder.truth',
                       ...
                       url(r'^edit/(\d+)[/]$',
                           'views.edit', name='truth-list-edit'),
                       url(r'^create/$',
                           'views.create', name='truth-list-create'),
                       url(r'^delete/(\d+)[/]$',
                           'views.delete', name='truth-list-delete'),
                       url(
                           r'^get_key_value_store/(\d+)[/]$', 'views.get_key_value_store',
                       name='truth-list-edit'),
                       url(
                           r'^create_key_value/(\d+)[/]$', 'views.create_key_value',
                       name='truth-list-create'),
                       url(
                           r'^save_key_value/(\d+)[/]$', 'views.save_key_value',
                       name='truth-list-save'),
                       url(
                           r'^delete_key_value/(\d+)/(\d+)[/]$', 'views.delete_key_value',
                       name='truth-list-delete'),
                       )
