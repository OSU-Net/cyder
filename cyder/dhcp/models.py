...
class DHCP(models.Model):
    ...
    pool_deny_dynamic_bootp_agents = models.IntegerField(
        max_length=32, choices=YES_NO_CHOICES)
    ...
    option_subnet_mask = models.CharField(
        max_length=16, choices=SUBNET_CHOICES)
    option_domain_name_servers = models.CharField(
