...
class SystemApi(TestCase):
    ...
    def test_update_system(self):
        ...
        self.assertEqual(201, resp.status_code)
        obj = json.loads(resp.content.split(" = ")[1])
        resp = self.client.put('/en-US/api/v2/system/%i/' % (obj[
                               'id']), {'hostname': 'updated_hostname'})
        self.assertEqual(200, resp.status_code)
        resp = self.client.get('/api/v2/system/%i/' % (obj['id']), follow=True)
        self.assertEqual(200, resp.status_code)
        self.assertEqual(
...
class KeyValueApi(TestCase):
    ...
    def test_keyvalue_set_invalid_is_dhcp_scope(self):
        resp = self.client.put('/en-US/api/v2/keyvalue/3/', {'system_id':
                               '2', 'value': 'true', 'key': 'is_dhcp_scope'})
        self.assertEqual(resp.status_code, 401)

    """def test_keyvalue_set_valid_is_dhcp_scope(self):
        resp = self.client.put('/en-US/api/v2/keyvalue/1/', {'system_id':
                               '1', 'value':'True','key':'is_dhcp_scope'})
        self.assertEqual(resp.status_code, 200)"""
    ...
    """def test_keyvalue_set_valid_dhcp_scope_start(self):
        resp = self.client.put('/en-US/api/v2/keyvalue/3/', {'system_id':'1',
                               'value':'10.99.32.1','key':'dhcp.scope.start'})
        self.assertEqual(resp.status_code, 200)"""
    ...
    """def test_keyvalue_set_valid_dhcp_scope_end(self):
        resp = self.client.put('/en-US/api/v2/keyvalue/3/', {'system_id':'2',
                               'value':'10.99.32.1','key':'dhcp.scope.end'})
        self.assertEqual(resp.status_code, 200)"""
    ...
    """def test_keyvalue_set_valid_dhcp_pool_start(self):
        resp = self.client.put('/en-US/api/v2/keyvalue/3/', {'system_id':'2',
                               'value':'10.99.32.1','key':'dhcp.pool.start'})
        self.assertEqual(resp.status_code, 200)"""
    ...
    """def test_keyvalue_set_valid_dhcp_pool_end(self):
        resp = self.client.put('/en-US/api/v2/keyvalue/3/', {'system_id':'2',
                               'value':'10.99.32.1','key':'dhcp.pool.end'})
        self.assertEqual(resp.status_code, 200)"""
